...
$(document).ready(function ()
{
	...
	ceoNode.setFullName("Samuel Badree");
	ceoNode.setImageLocation("ceo.png");
	ceoNode.setComment("The ED of IOCL BGR");
	ceoNode.resize();
	...
	ctoNode.setTitle("GM");
	ctoNode.setFullName("Joe Sharma");
	ctoNode.setImageLocation("cto.png");
	ctoNode.setComment("I S Manager");
	ctoNode.resize();
	...
	hrNode.setTitle("HR");
	hrNode.setFullName("Allison Das");
	hrNode.setImageLocation("hr.png");
	hrNode.setComment("Human and Resource Manager");
	hrNode.resize();
	...
	mediaNode.setFullName("Shifu Barman");
