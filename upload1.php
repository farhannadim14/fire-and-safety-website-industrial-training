...
<head>
	...
	<title>File Upload PHP Script</title>
</head>
<body>
<nav class="navbar">
    <a href="http://127.0.0.1:5501/index.html"><button class="btn">Back</button></a>
    </nav>
	<div id="info" style="right: 0px; bottom: 24px;">
		<div id="infoTab" style="padding: 10px;">
			<h1>
				About this Upload Box</h1>
			<p>
				Connected with MySQL using phpmyadmin.Having a download page as well.
			</p>
			<h4>
			<ul>Features
				<li>Upload any file but size should not exceed 10mb.</li>
				<li>after uploading a sharelink appears from which you can download it.</li>
				<li>In the share link copy the link and when pasting in the browser please remove upload1.php , if it stays it will show error such as URL not found!</li>
				<li>after uploading  a file it will be stored in the database as well as in a folder named as uploads for further use.</li>
