...
function C(a,b){a=A(a);return void 0===a&&void 0!==b?b:Number(a||0)}
function A(a){var b=y("EXPERIMENTS_FORCED_FLAGS",{});return void 0!==b[a]?b[a]:y("EXPERIMENT_FLAGS",{})[a]}
;var ha=C("web_emulated_idle_callback_delay",300),D=1E3/60-3,ba=[8,4,3,2,1,0];
function E(a){a=void 0===a?{}:a;t.call(this);this.g=[];for(var b=g(),c=b.next();!c.done;c=b.next())this.g[c.value]=[];this.j=0;this.N=a.timeout||1;this.i={};this.o=D;this.C=this.h=this.m=0;this.D=this.l=!1;this.u=[];this.H=q(this.R,this);this.M=q(this.T,this);this.J=q(this.O,this);this.K=q(this.P,this);this.L=q(this.S,this);this.A=this.F=!1;this.I=!!window.requestIdleCallback&&!!window.cancelIdleCallback&&!z("disable_scheduler_requestIdleCallback");(this.v=!!a.useRaf&&!!window.requestAnimationFrame)&&
...
function O(a,b){a.A&&4==a.m&&a.h||L(a);a.l=!0;b=Date.now()+(b||a.o);for(var c=a.g[4];c.length;){var d=c.shift(),e=a.i[d];delete a.i[d];e&&I(e)}c=a.F?0:1;c=a.j>c?a.j:c;if(!(Date.now()>=b)){do{a:{d=a;e=c;for(var B=3;B>=e;B--)for(var V=d.g[B];V.length;){var W=V.shift(),X=d.i[W];delete d.i[W];if(X){d=X;break a}}d=null}d&&I(d)}while(d&&Date.now()<b)}a.l=!1;Q(a);a.o=D;N(a)&&a.start()}
...
f.G=function(){M(this);L(this);this.v&&document.removeEventListener("visibilitychange",this.H);t.prototype.G.call(this)};var R=p("yt.scheduler.instance.timerIdMap_")||{},S=C("kevlar_tuner_scheduler_soft_state_timer_ms",800),T=0,U=0;function Y(){var a=p("ytglobal.schedulerInstanceInstance_");if(!a||a.s)a=new E(y("scheduler")||{}),r("ytglobal.schedulerInstanceInstance_",a);return a}
